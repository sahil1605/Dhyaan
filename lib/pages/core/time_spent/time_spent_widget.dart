...
import 'time_spent_model.dart';
export 'time_spent_model.dart';

class TimeSpentWidget extends StatefulWidget {
  const TimeSpentWidget({super.key});

  static String routeName = 'TimeSpent';
  static String routePath = '/timeSpent';
...
class _TimeSpentWidgetState extends State<TimeSpentWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimeSpentModel());
