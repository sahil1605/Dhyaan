...
import 'app_selection_page_model.dart';
export 'app_selection_page_model.dart';

class AppSelectionPageWidget extends StatefulWidget {
  const AppSelectionPageWidget({super.key});

  static String routeName = 'AppSelectionPage';
  static String routePath = '/appSelectionPage';

  @override
  State<AppSelectionPageWidget> createState() => _AppSelectionPageWidgetState();
}

class _AppSelectionPageWidgetState extends State<AppSelectionPageWidget>
    with TickerProviderStateMixin {
  late AppSelectionPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AppSelectionPageModel());
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Container(
                                        width: 1000.0,
                                        height: 490.0,
                                        child: custom_widgets.InstalledAppsList(
                                          width: 1000.0,
                                          height: 490.0,
                                        ),
                                      ),
